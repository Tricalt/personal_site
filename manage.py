...
from personal_app.app import create_app
from personal_app.database import db
from personal_app.settings import DevConfig, ProdConfig
from personal_app.user.models import User

CONFIG = ProdConfig if os.environ.get('PERSONAL_APP_ENV') == 'prod' else DevConfig
